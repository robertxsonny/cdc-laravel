@extends('master')
  ...
  <div class="row">
    <div class="col-md-3 col-sm-4 col-xs-12">
      <h3><strong>Add Artist</strong></h3>
    </div>
    <div class="col-md-8 col-md-offset-1 col-sm-8 col-xs-12">
        @if ($errors->any())
            ...
            @endforeach
        @endif
      <form enctype="multipart/form-data" class="" action="{{route('artist.store')}}" method="post">
        {{csrf_field()}}
        ...
        <div class="form-group{{ ($errors->has('genre')) ? $errors->first('genre') : '' }}">
          <input type="text" name="genre" class="form-control" placeholder="Artist genre">
          {!! $errors->first('genre','<p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group{{ ($errors->has('country')) ? $errors->first('country') : '' }}">
          <input type="text" name="country" class="form-control" placeholder="Artist country">
